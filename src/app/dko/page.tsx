...
export default function DeafKidsOutreachPage() {
    ...
    return (
        <div className="flex flex-col bg-white text-black w-full min-h-screen mt-[75px] sm:px-96 px-4">
            <h1 className="text-4xl sm:text-6xl font-bold">Deaf Kids Outreach</h1>
            <div className="flex flex-col">
                <div
                    className={`h-fit w-fit border-4 sm:border-8 border-black sm:rounded-3xl rounded-2xl overflow-clip bg-white self-center mt-8 shadow-2xl`}>
                    <Image
                        src={DKO}
                        height={500}
                        width={800}
            ...
            <div className="sm:hidden flex flex-col mt-4 gap-5 w-full">
                <div
                ...
                <div>
                    <div
                        ...
                        <h2>S</h2><FaDiamond size={14} className="-rotate-90 mt-[8px] mr-[1px] text-[#dd462c]"/>
                        <h2>lution</h2>
                    </div>
                    <p>Implement ASL as an official language on Khan Academy, standardize video creation, and
                        create a platform for submitting, reviewing, providing feedback, and approving or
            ...
            <div className="flex flex-col items-center sm:mt-8 gap-5 sm:gap-10 pt-8">
                <div className="flex flex-col w-full gap-2 max-w-[960px]">
                    <h3 className="text-xl sm:text-2xl font-semibold">Background</h3>
                    <p className="indent-4 sm:indent-8">Deaf Kids Outreach was the first "real world" project that I worked on. I
                    ...
                    <p className="indent-4 sm:indent-8">Having been very inexperienced at the time, my responsibilities were to
                        create the login and signup pages.
                    </p>
                </div>
                <div className="flex flex-col sm:flex-row w-full max-w-[960px] gap-8">
                    <div>
                        <div
                            className={`relative border-2 sm:border-4 border-black rounded-3xl overflow-hidden`}>
                            <Image
                                src={LoginProto}
                        ...
                        <p className="bg-transparent mt-1 ml-1 max-w-[960px] text-xs sm:text-md">Login Prototype #1</p>
                    </div>
                    <div className="sm:w-[50%] flex flex-col">
                        <h5 className="font-medium">Login Prototype #1</h5>
                        <p className="bg-transparent indent-4 sm:indent-8"> At this stage of
                        ...
                        <p className="bg-transparent indent-4 sm:indent-8">At this stage, we had completed our first design review,
                        ...
                        <IoArrowDown className="self-center mt-14 text-[#dd462c] animate-bounce hidden sm:flex" size={100}/>
                        <IoArrowDown className="self-center text-[#dd462c] animate-bounce flex sm:hidden" size={40}/>
                    </div>
                </div>
                <div>
                    <div
                        className={`relative border-2 sm:border-4 border-black rounded-2xl sm:rounded-3xl overflow-hidden`}>
                        <Image
                            src={LoginProto2}
                            width={960}
                    ...
                    <p className="bg-transparent mt-1 ml-1 max-w-[960px] text-sm sm:text-md">Login Prototype #2</p>
                </div>
                <div>
                    <div
                        className={`relative border-2 sm:border-4 border-black rounded-2xl sm:rounded-3xl overflow-hidden`}>
                    ...
                    <p className="bg-transparent mt-1 ml-1 max-w-[960px] text-sm sm:text-md">Final Login page</p>
                </div>
                <div className="max-w-[960px]">
                    <h2 className="text-lg sm:text-xl font-medium mb-1">Example Input Code from Sign Up Page</h2>
                    <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                        ...
                        <div className="flex flex-col gap-2 sm:gap-4 items-center">
                            <div
                                className="flex flex-col items-center justify-center h-max border-2 border-black rounded-2xl py-10 sm:py-[70px] w-[358px] sm:w-full">
                                <div className="flex flex-col items-start">
                                    <label>First Name</label>
                                    <input className="textInput min-w-[200px]" type="text" placeholder={""} value={firstName}
                ...
                <div>
                    ...
                    <p className="bg-transparent mt-1 ml-1 max-w-[960px] text-sm sm:text-md">Sign up page, one of the first pages I
                        completed using CSS Grid.</p>
                </div>
                <div className="flex flex-col w-full gap-2 max-w-[960px]">
                    <h3 className="text-xl sm:text-2xl font-semibold">Takeaways</h3>
                    <p className="indent-4 sm:indent-8">Taking this class in my first year of college significantly contributed to
                    ...
                    <p className="indent-4 sm:indent-8">As a young and ambitious student, I learned that large-scale projects
